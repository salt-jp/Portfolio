...
class Bouncer {
	  ...
	  show(){
			...
			triangle(this.x,this.y, 1, 5, 10, 10);// this makes weird line and its kinda cool so backup i guess EDIT; IT IS COOL I FIGURED IT OUT
			//triangle(this.x,this.y, 20, 20, 5, 5);
		}
}
function setup() {
